...
<head>
    ...
    <title>Blogger Ebook App - Notifications</title>
    <!-- Google Fonts -->
        ...
        <div class="card corner-radius">
            <div class="body">
                <form id="form_validation" method="post">
					...
					<div class="input-group form-group">
                        <div class="form-line">
                            <div class="font-12">Post Id (Optional)</div>
                            <input type="text" class="form-control" name="post_id" placeholder="Post Id (Optional)">
                        </div>
                    </div>
